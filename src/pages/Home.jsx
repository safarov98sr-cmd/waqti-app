        ...
        >
          {user ? (
            <>
              ...
              <button
                onClick={() => { setOpen(false); window.dispatchEvent(new CustomEvent('waqti:navigate', { detail: 'settings' })) }}
                className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all active:scale-95 mb-1"
                style={{ color: 'var(--text-h)', background: 'var(--bg-s1)', touchAction: 'manipulation', WebkitTapHighlightColor: 'transparent' }}
              >
              ...
              <button
                ...
                style={{ color: '#EF4444', background: 'rgba(239,68,68,0.06)', touchAction: 'manipulation', WebkitTapHighlightColor: 'transparent' }}
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
